...
ทดสอบทักษะที่ได้เรียนมาใน Module 2 ผ่านโปรเจกต์คำนวณ BMI:

### 🎯 Challenge 1: Formatting
**หัวข้อ:** สูตรคำนวณ BMI

**โจทย์:** ตอนนี้เลขทศนิยมมันยาวเหยียด (เช่น `22.857142...`) ลองหาวิธีทำให้เหลือแค่ **2 ตำแหน่ง** ดูสิ!
...
**หัวข้อ:** สูตรคำนวณ BMI + Category

**โจทย์:** เพิ่มระบบ **แปลผล BMI** ให้บอกว่าอยู่ในระดับไหน:
...
**หัวข้อ:** Template Literal Output

**โจทย์:** ใช้ Template Literal สร้างผลลัพธ์สวยๆ แบบนี้:
