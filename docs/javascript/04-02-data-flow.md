...
> **⚠️ คำเตือน:** การส่ง Object เข้าฟังก์ชันแล้วแก้ไขข้างใน ถือเป็น **Side Effect** ที่ทำให้โค้ด Debug ยาก ถ้าเป็นไปได้ควร **Copy ก่อนแก้** (เรื่องนี้เจาะลึกในบท [05-3: Reference vs Value](/javascript/05-03-reference-vs-value))
...
👉 **[ไปต่อ: 04-3 - Scope & Closures](/javascript/04-03-scope-closures)**
