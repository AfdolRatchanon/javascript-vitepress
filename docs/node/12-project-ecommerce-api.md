...
const upload = require('../middleware/upload'); // (จาก module 10)
const Product = require('../models/Product');
const { verifyToken, isAdmin } = require('../middleware/auth'); // (จาก module 9)
...
ก่อนส่งงาน (หรือขึ้น Production) อย่าลืม:
...
3.  **Use PM2**: ใช้ Process Manager (`pm2`) รัน Node.js เพื่อให้มัน restart เองเวลามี error
...
ตอนนี้คุณมีความรู้พอที่จะสร้าง Backend ให้กับ Web Application ระดับกลางได้แล้ว

**What's Next?** (ไปไหนต่อดี?)
- ศึกษาระบบ **Payment Gateway** (Stripe / Omise) เพื่อรับเงินจริง
- ศึกษา **Docker** เพื่อ Containerize แอปของเรา
- ศึกษา **Microservices** ถ้าอยากสเกลระบบให้ใหญ่ระดับ Enterprise
- หรือข้ามไปเรียนฝั่ง Frontend (React/Vue) เพื่อเป็น **Fullstack Developer**!
